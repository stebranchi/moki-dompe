...
<div ng-controller="getListController as demo" class="container">
	 ...
	 <div class="tab-content clearfix">	 
		...
		<div ng-repeat="tab in tabs" class="tab-pane" ng-class="tab.active">
			...
			<moki-range-datatype model="tab.model_range" datatype-list="datatype_values"></moki-range-datatype>
			<moki-mapping model="tab.model_mapping" class-list="datatype_list"></moki-mapping>
...
<script src="js/listmanager/datatype_propertyList.js"></script>
